...
.config(function($stateProvider, $urlRouterProvider) {
  ...
  .state('app', {
    url: "/app",
    abstract: true,
    templateUrl: "templates/fr/menu.html",
    controller: 'AppCtrl'
  })
  ...
  .state('app.qnalist', {
    ...
    views: {
      'tab-qnalist': {
        templateUrl: "templates/fr/qnalist.html",
  ...
  .state('app.qnareg', {
    ...
    views: {
      'tab-qnalist': {
        templateUrl: "templates/fr/qnareg.html",
  ...
  .state('app.qnaview', {
    ...
    views: {
      'tab-qnalist': {
        templateUrl: "templates/fr/qnaview.html",
  ...
  .state('app.qnaupdate', {
    ...
    views: {
      'tab-qnalist': {
        templateUrl: "templates/fr/qnaupdate.html",
  ...
  .state('app.notice', {
    ...
    views: {
      'tab-notice': {
        templateUrl: "templates/fr/notice.html",
  ...
  .state('app.noticereg', {
    ...
    views: {
      'tab-notice': {
        templateUrl: "templates/fr/noticereg.html",
  ...
  .state('app.noticeupdate', {
    ...
    views: {
      'tab-notice': {
        templateUrl: "templates/fr/noticeupdate.html",
  ...
  .state('app.friendlist', {
    ...
    views: {
      'tab-friend': {
        templateUrl: "templates/fr/friendlist.html",
  ...
  .state('app.friendreg', {
    ...
    views: {
      'tab-friend': {
        templateUrl: "templates/fr/friendreg.html",
        controller: 'friendlistCtrl'
      }
    }
  })
