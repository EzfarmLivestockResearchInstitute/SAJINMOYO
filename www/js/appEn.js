...
.config(function($stateProvider, $urlRouterProvider) {
  ...
  .state('app', {
    url: "/app",
    abstract: true,
    templateUrl: "templates/en/menu.html",
    controller: 'AppCtrl'
  })
  ...
  .state('app.qnalist', {
    ...
    views: {
      'tab-qnalist': {
        templateUrl: "templates/en/qnalist.html",
  ...
  .state('app.qnareg', {
    ...
    views: {
      'tab-qnalist': {
        templateUrl: "templates/en/qnareg.html",
  ...
  .state('app.qnaview', {
    ...
    views: {
      'tab-qnalist': {
        templateUrl: "templates/en/qnaview.html",
  ...
  .state('app.qnaupdate', {
    ...
    views: {
      'tab-qnalist': {
        templateUrl: "templates/en/qnaupdate.html",
  ...
  .state('app.notice', {
    ...
    views: {
      'tab-notice': {
        templateUrl: "templates/en/notice.html",
  ...
  .state('app.noticereg', {
    ...
    views: {
      'tab-notice': {
        templateUrl: "templates/en/noticereg.html",
  ...
  .state('app.noticeupdate', {
    ...
    views: {
      'tab-notice': {
        templateUrl: "templates/en/noticeupdate.html",
  ...
  .state('app.friendlist', {
    ...
    views: {
      'tab-friend': {
        templateUrl: "templates/en/friendlist.html",
  ...
  .state('app.friendreg', {
    ...
    views: {
      'tab-friend': {
        templateUrl: "templates/en/friendreg.html",
        controller: 'friendlistCtrl'
      }
    }
  })
